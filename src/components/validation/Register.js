      ...
      <div id="register">
        <div id="regarea">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <span className="helper-text" data-error="wrong" data-success="right">Already have an account? <Link to="/login"><a><u style={{color:"rgb(11, 123, 29)"}}>Sign in</u></a></Link></span><br/>
                <br></br>
                <button className="btn save-button" type="submit" name="signin" style={{margintop:"30px",background:"rgb(11, 123, 29)"}}>Create Account
